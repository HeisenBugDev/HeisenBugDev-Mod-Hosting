...
ActiveRecord::Schema.define(version: 20_140_726_211_659) do
  ...
  add_index 'projects_users', %w(project_id user_id), name: 'index_projects_users_on_project_id_and_user_id'
  add_index 'projects_users', %w(user_id project_id), name: 'index_projects_users_on_user_id_and_project_id'
